  ...
  return (
    <div>
      ...
      <div className="border rounded p-4 mb-3">
        ...
        <div className="border rounded p-6 mb-5 bg-white ">
          ...
          <div className="bg-blue-50 p-4 rounded-lg border border-blue-200 mb-6">
            <div className="flex">
              ...
              <p className="text-blue-700 text-sm">
                Please note that the annual contract amount only includes Turn
                Over services. If you win this contract, you'll have the
                opportunity to earn more with Common Areas. During your first
                visit to the property, you can set your price and coordinate all
                additional payment details with our PINCH team.
              </p>
            </div>
          </div>
        )}
